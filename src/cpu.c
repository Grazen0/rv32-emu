...
static u32 Cpu_read_u32(const u8 *const memory, const u32 addr)
{
...
static u16 Cpu_read_u16(const u8 *const memory, const u32 addr)
{
...
static void Cpu_write_u32(u8 *const memory, const u32 addr, const u32 value)
{
    memory[addr] = value;
...
static void Cpu_write_u16(u8 *const memory, const u32 addr, const u16 value)
{
    memory[addr] = value;
    memory[addr + 1] = value >> 8;
}
...
void Cpu_step(Cpu *const cpu)
{
    ...
    case 0b011'0011: {
        ...
        case 0b010:
            ...
            break;
        case 0b011:
            cpu->registers[rd] = (u32)cpu->registers[rs1] < (u32)cpu->registers[rs2];
            break;
        case 0b100:
            cpu->registers[rd] = cpu->registers[rs1] ^ cpu->registers[rs2];
            break;
